...
import UserProductArchiveCard from "@/components/UserProductArchiveCard";
import UserProductFavoritesCard from "@/components/UserProductFavoritesCard";
              ...
              <TabPanel value="2">
                {
                  data?.content ? (
                    data?.content?.length > 0 ? (
                      data?.content?.map((item: MainProductsType) => <UserProductCard key={item.id} data={item} />)
                    ) : (
                      <p className="text-center text-gray-500">Faol e’lonlar mavjud emas</p>
                    )
                  ) : (
                    <CarCardSkeleton />
                  )
              ...
              <TabPanel value="3">
                {
                  data?.content ? (
                    data?.content?.length > 0 ? (
                      data?.content?.map((item: MainProductsType) => <UserProductArchiveCard key={item.id} data={item} />)
                    ) : (
                      <p className="text-center text-gray-500">Arxivlangan e’lonlar mavjud emas</p>
                    )
                  ) : (
                    <CarCardSkeleton />
                  )
              ...
              <TabPanel value="4">
                {
                  data?.content ? (
                    data?.content?.length > 0 ? (
                      data?.content?.map((item: MainProductsType) => <UserProductFavoritesCard key={item.id} data={item} />)
                    ) : (
                      <p className="text-center text-gray-500">Kutilayotgan e’lonlar mavjud emas</p>
                    )
                  ) : (
                    <CarCardSkeleton />
                  )
