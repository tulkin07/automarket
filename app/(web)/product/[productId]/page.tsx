        ...
        <div className="flex w-full flex-col gap-5 border p-5 border-[#E0E2E6] rounded-2xl">
          ...
          <ul className="grid grid-cols-2 gap-3">
            ...
            <li>
              ...
              <span className="font-medium">Oq</span>
            </li>
            <li>
              <p className="text-[#575E6B] text-sm">Yonilgi turi</p>
              <span className="font-medium">Benzin</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="font-medium">Avtomat</span>
            </li>
          </ul>
        </div>
        <div className="min-w-80 border p-5 border-[#E0E2E6] rounded-2xl p-6">
          ...
          <div className="flex flex-col gap-3 my-4">
            <div className="flex justify-between">
              ...
              <span className="font-medium">Alisher Ikramov</span>
            </div>
            <div className="flex justify-between">
              <span className="flex gap-2 text-[#575E6B]">
                <Image
              ...
              <span className="text-[#55A6F6] font-medium">+998 90 123 45 67</span>
            </div>
            <div className="flex justify-between">
              <span className="flex gap-2 text-[#575E6B]">
          ...
          <div className="flex flex-col gap-4">
            <button className="text-white rounded-xl font-medium w-full h-10 bg-[#55A6F6]">Savol berish</button>
